...
pub fn bindings() -> tauri_specta::Builder<tauri::Cef> {
    ...
    Builder::new()
        .commands(collect_commands![
            ...
            editing::move_layer,
            editing::reorder_layers,
            editing::undo,
            editing::redo,
            processing::process,
            processing::stop_job,
            processing::export_chapter_translation,
            processing::import_chapter_translation,
            output::export_pages,
            ...
            preferences::get_inpainting_models,
